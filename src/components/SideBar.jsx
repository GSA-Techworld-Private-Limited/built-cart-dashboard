...
const DashboardSideBar = () => {
  ...
  return (
    <div className="rounded-br-[30px] flex flex-col gap-[14px] w-[265px] bg-dark pt-24 2xl:pt-32 pb-12 h-[calc(100vh-86.59px)] 2xl:h-[calc(100vh-110px)] overflow-auto hide_scroll">
      <AdminTabBtn
        btntext="Dashboard"
