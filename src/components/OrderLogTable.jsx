...
const OrderLogTable = () => {
  ...
  return (
    <>
      <div>
        <div className="w-[2000px] 2xl:w-[2966px]">
          <div className="bg-[#BDBDBD] h-12 2xl:h-16 flex items-center">
            ...
            <p className="font-semibold text-nowrap pl-6 w-[150px] 2xl:w-[232px] table-text">
              Order ID
            </p>
            ...
            <p className="font-semibold text-nowrap pl-6 w-[200px] 2xl:w-[314px] table-text">
              Items
            </p>
            <p className="font-semibold text-nowrap pl-6 w-[150px] 2xl:w-[240px] table-text">
              Vendor
            </p>
              ...
              .map((val, i) => (
                ...
                >
                  ...
                  <p
                    ...
                    className="font-medium cursor-pointer underline hover:no-underline duration-300 text-nowrap pl-6 w-[150px] 2xl:w-[232px] 2xl:text-2xl text-base leading-5 text-dark"
                  >
                    {val.order_id}
                  </p>
                  ...
                  <p className="font-medium text-nowrap pl-6 w-[200px] 2xl:w-[314px] table-text">
                    {val.order_item}
                  </p>
                  <p className="font-medium capitalize text-nowrap pl-6 w-[150px] 2xl:w-[240px] table-text">
                    {val.vendor_name}
                  </p>
                  <p className="font-medium text-nowrap pl-6 w-[119px] table-text">
                    {val.quantity}
                  </p>
                  <p className="font-medium text-nowrap pl-6 w-[150px] 2xl:w-[199px] table-text">
                    ₹{val.total_price}
                  </p>
                  <p className="font-medium uppercase text-nowrap pl-6 w-[180px] 2xl:w-[244px] table-text">
                    {val.payment_mode}
                  </p>
                  <p className="font-medium capitalize text-nowrap pl-6 w-[180px] 2xl:w-[244px] table-text">
                    {val.delivery_person}
                  </p>
                  <p
                    className={`font-medium text-nowrap capitalize pl-6 w-[180px] 2xl:w-[244px] 2xl:text-2xl text-base leading-5 ${
