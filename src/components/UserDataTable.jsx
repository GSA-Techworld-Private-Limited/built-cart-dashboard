      ...
      <div>
        <div className="w-[1740px]">
          ...
          <div className="px-[68px]"></div>
            ...
            <p className="font-semibold text-nowrap pl-6 w-[243px] table-text">
              Status
            </p>
          </div>
          {userData &&
              ...
              .map((val, i) => (
                ...
                >
                  ...
                  <p
                    ...
                    className="font-medium cursor-pointer underline hover:no-underline duration-300 text-nowrap pl-6 w-[204px] table-text"
                  >
                    {val.full_name}
                  </p>
